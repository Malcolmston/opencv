...
// the Guo–Hall thinning variant; domain-transform and adaptive-manifold
// filtering; structured-edge and fast global smoother; and SLIC label counts
// beyond 256 (labels are returned in a [cv.Mat], whose samples are 8-bit — see
// [SuperpixelSLIC]).
package ximgproc
