...
// the GitHub Releases API for malcolmston/opencv.
const RELEASE_LIBS: RelLib[] = [
  { name: OPENCV.name, icon: OPENCV.icon, accent: OPENCV.accent, repo: ghrepo(OPENCV), url: OPENCV.repo },
];
