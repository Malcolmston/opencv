...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/opencv', initials: 'cv', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/opencv</span> — classic OpenCV image processing, reimagined in Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · independent re-implementation of OpenCV (cv2)</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/opencv" footer={footer}>
